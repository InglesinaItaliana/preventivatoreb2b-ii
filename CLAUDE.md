...
|---|---|---|
| `preventivi` | Doc unico preventivo→ordine→DDT | `stato`, `clienteUID`, `elementi[]`, `totaleImponibile/totaleScontato/netCanonico`, `commessa`, billing `billingBackend/billingError/fic_*/cic_*`, spedizione `colli/corriere/trackingCode`, `destinazione` (luogo di consegna alternativo) |
